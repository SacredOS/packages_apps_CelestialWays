...
public class CelestialWays extends SettingsPreferenceFragment {
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        addPreferencesFromResource(R.xml.celestialways);
    ...
    private static class SummaryProvider implements SummaryLoader.SummaryProvider {
        ...
        public void setListening(boolean listening) {
            if (listening) {
                mSummaryLoader.setSummary(this, mContext.getString(R.string.celestial_ways_summary));
            }
        }
    }
